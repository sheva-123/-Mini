                    ...
                    <tbody>
                        @foreach ($pemeliharaans as $pemeliharaan)
                            <tr class="bg-white border-b hover:bg-gray-100">
                                ...
                                <td class="px-6 py-4">{{ $pemeliharaan->pertanian->nama_pertanian ?? 'Tidak diketahui' }}
                                </td>
                                ...
                                <td class="px-6 py-4 flex items-center space-x-4">
                                    <a href="{{ route('pemeliharaans.edit', $pemeliharaan->id) }}"
                                    ...
                                    <form action="{{ route('pemeliharaans.destroy', $pemeliharaan->id) }}" method="POST"
                                        ...
                                        <button type="submit" class="text-red-500 hover:text-red-700"
                                            ...
                                            <svg viewBox="0 0 24 24" class="w-6 h-6" fill="none"
                                                ...
                                                <path d="M18 6L6 6M12 6v12m6 0H6" stroke="#ff0000" stroke-width="2"
