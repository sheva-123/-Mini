...
<div class="flex flex-col md:flex-row justify-between items-center px-4 pt-2 gap-4">
    ...
    <form action="{{ route('penanamans.index') }}" method="get" class="flex flex-wrap items-end gap-3 w-full md:w-auto">
        ...
        <div class="relative">
            ...
            <input type="text" id="search" placeholder="Cari..." name="search" value="{{ request()->get('search') }}"
                class="w-full sm:w-56 px-4 py-2 rounded-lg border border-gray-300 focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none shadow-sm">
        ...
        <div class="flex flex-col">
            ...
            <input type="date" name="tanggal_awal" id="tanggal_awal" value="{{ request('tanggal_awal') }}"
                class="px-4 py-2 rounded-lg border border-gray-300 focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none w-full sm:w-auto">
        </div>
        ...
        <div>
            ...
            <select name="sort" id="sort"
                class="px-4 py-2 rounded-lg border border-gray-300 focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none shadow-sm hover:bg-gray-50 w-full sm:w-40">
    ...
    <a href="{{ route('laporans.create') }}"
        class="ml-auto bg-green-600 text-white mt-5 px-5 py-2 rounded-lg shadow-lg hover:bg-green-700 transition-transform transform hover:scale-95 w-full md:w-auto text-center">
        Tambah
    </a>
</div>
