...
<body class="bg-gradient-to-r from-green-500 to-green-700 text-white font-sans">
    ...
    <nav class="fixed w-full z-50 bg-transparent text-white shadow-lg">
        <div class="max-w-7xl mx-auto px-6 py-6 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-10">
                ...
                <!-- Navbar -->
                <div class="hidden lg:flex space-x-10 text-lg">
            ...
            <div class="flex space-x-3">
                <a href="{{ route('login') }}"
                    class="px-4 py-2 bg-green-700 text-white font-semibold text-lg rounded-xl hover:bg-green-800 transition ease-in-out duration-500">Masuk</a>

                <a href="{{ route('register') }}"
                    class="px-4 py-2 border-2 border-green-700 text-light font-semibold text-lg rounded-xl hover:bg-green-800 hover:text-white transition ease-linear duration-500">Daftar</a>
            </div>
        </div>
    </nav>
    ...
    <section class="relative h-screen bg-cover bg-center flex items-center justify-center text-center"
        ...
        <div class="relative z-10 px-6 md:px-12">
            <h1 class="text-5xl sm:text-6xl font-bold leading-tight text-yellow-400">Transformasi Pertanian Anda dengan
                Teknologi Canggih</h1>
            <p class="mt-4 text-lg sm:text-2xl text-white">Solusi manajemen pertanian untuk hasil yang lebih baik dan
                berkelanjutan.</p>
            <a href="#contact"
                class="mt-8 inline-block bg-yellow-500 text-black px-8 py-4 rounded-full text-lg font-semibold shadow-xl hover:bg-yellow-400 transition duration-300">Hubungi
                Kami</a>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-6 text-center">
            ...
            <div class="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
                ...
                <div class="bg-gray-100 p-10 rounded-2xl shadow-xl hover:shadow-2xl transition duration-300">
                    ...
                    <p class="mt-4 text-lg text-gray-600">Pantau kondisi tanaman Anda menggunakan sensor dan perangkat
                        IoT untuk hasil yang lebih optimal.</p>
                </div>
                <!-- Feature 2 -->
                <div class="bg-gray-100 p-10 rounded-2xl shadow-xl hover:shadow-2xl transition duration-300">
                    <div class="text-4xl text-green-600 mb-6">
                    ...
                    <p class="mt-4 text-lg text-gray-600">Kontrol irigasi tanaman secara otomatis untuk menghemat air
                        dan memastikan tanaman mendapat kelembapan yang tepat.</p>
                </div>
                <!-- Feature 3 -->
                <div class="bg-gray-100 p-10 rounded-2xl shadow-xl hover:shadow-2xl transition duration-300">
                    <div class="text-4xl text-green-600 mb-6">
                    ...
                    <p class="mt-4 text-lg text-gray-600">Dapatkan wawasan dan rekomendasi berbasis data untuk
                        meningkatkan hasil dan keberlanjutan pertanian Anda.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-24 bg-green-600 text-white" id="contact">
        <div class="max-w-7xl mx-auto px-6 text-center">
            ...
            <a href="mailto:info@agritech.com"
                class="mt-8 inline-block bg-yellow-500 text-black px-8 py-4 rounded-full text-lg font-semibold shadow-xl hover:bg-yellow-400 transition duration-300">Kirim
                Email</a>
        </div>
    </section>
    ...
    <footer class="bg-gray-900 text-white py-6">
        <div class="max-w-7xl mx-auto text-center">
            <p>&copy; 2024 AgriTech. Semua hak dilindungi. <br> Dibangun dengan cinta untuk masa depan pertanian yang
                lebih baik.</p>
        </div>
    </footer>
